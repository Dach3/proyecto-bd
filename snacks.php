...
<div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <a href="anuncio.php?id=<?php echo $producto->id;?>" class="boton-amarillo-block carrito-boton">
                    <img class="carrito-img" src="build/img/pngegg.svg" alt="">
                        <p>Agregar</p> 
                    </a>
    ...
    <a class="boton boton-verde" href="Productos.php">Volver</a>
